 ...
 * @brief MainWindow::updateEuation
 */
...
void MainWindow::on_radioButton_orthograficPerspective_toggled(bool checked)
{

}

void MainWindow::on_radioButton_projectivePerspective_toggled(bool checked)
{
