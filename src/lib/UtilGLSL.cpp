/*/////////////////////////////////////////////////////////////////////////////////////////////////
module:  Implementation of GLSL utility class
purpose: Implements general utilities for OpenGL GLSL support
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	const char* vert_shader_code =
		...
		"void main(void) { gl_Position = gl_ModelViewProjectionMatrix * vertPosition; }";

	const char* frag_shader_code =
		"#version 420 core \n"\
		"out vec4 fragColor; \n"\
		"void main(void) { fragColor = vec4(0.5, 0.5, 0.5, 1.0); }";
	...
	if ( argc == 1)
	{
		// no command line arguments specified, use default shaders
		cout << "Loading default: minimal shaders" << endl;
		shader = glCreateShader(GL_VERTEX_SHADER);
		glShaderSource(shader, 1, &vert_shader_code, NULL);
		...
		glShaderSource(shader, 1, &frag_shader_code, NULL);
		glCompileShader(shader);
		checkShaderInfoLog(shader);
		glAttachShader(program, shader);
		glDeleteShader(shader);          // flag shader for deletion
